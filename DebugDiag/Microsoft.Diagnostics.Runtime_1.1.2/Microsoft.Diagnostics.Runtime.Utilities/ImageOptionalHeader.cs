...
public class ImageOptionalHeader
{
	...
	public ulong ImageBase
	{
		get
		{
			if (!_32bit)
			{
				return _optional.ImageBase64;
			}
			return _optional.ImageBase;
		}
	}
	...
	public Microsoft.Diagnostics.Runtime.Interop.IMAGE_DATA_DIRECTORY ExportDirectory => _directories.Value[0];

	public Microsoft.Diagnostics.Runtime.Interop.IMAGE_DATA_DIRECTORY ImportDirectory => _directories.Value[1];

	public Microsoft.Diagnostics.Runtime.Interop.IMAGE_DATA_DIRECTORY ResourceDirectory => _directories.Value[2];

	public Microsoft.Diagnostics.Runtime.Interop.IMAGE_DATA_DIRECTORY ExceptionDirectory => _directories.Value[3];

	public Microsoft.Diagnostics.Runtime.Interop.IMAGE_DATA_DIRECTORY CertificatesDirectory => _directories.Value[4];

	public Microsoft.Diagnostics.Runtime.Interop.IMAGE_DATA_DIRECTORY BaseRelocationDirectory => _directories.Value[5];

	public Microsoft.Diagnostics.Runtime.Interop.IMAGE_DATA_DIRECTORY DebugDirectory => _directories.Value[6];

	public Microsoft.Diagnostics.Runtime.Interop.IMAGE_DATA_DIRECTORY ArchitectureDirectory => _directories.Value[7];

	public Microsoft.Diagnostics.Runtime.Interop.IMAGE_DATA_DIRECTORY GlobalPointerDirectory => _directories.Value[8];

	public Microsoft.Diagnostics.Runtime.Interop.IMAGE_DATA_DIRECTORY ThreadStorageDirectory => _directories.Value[9];

	public Microsoft.Diagnostics.Runtime.Interop.IMAGE_DATA_DIRECTORY LoadConfigurationDirectory => _directories.Value[10];

	public Microsoft.Diagnostics.Runtime.Interop.IMAGE_DATA_DIRECTORY BoundImportDirectory => _directories.Value[11];

	public Microsoft.Diagnostics.Runtime.Interop.IMAGE_DATA_DIRECTORY ImportAddressTableDirectory => _directories.Value[12];

	public Microsoft.Diagnostics.Runtime.Interop.IMAGE_DATA_DIRECTORY DelayImportDirectory => _directories.Value[13];

	public Microsoft.Diagnostics.Runtime.Interop.IMAGE_DATA_DIRECTORY ComDescriptorDirectory => _directories.Value[14];

	internal ImageOptionalHeader(IMAGE_OPTIONAL_HEADER_AGNOSTIC optional, Lazy<IMAGE_OPTIONAL_HEADER_SPECIFIC> specific, Lazy<Microsoft.Diagnostics.Runtime.Interop.IMAGE_DATA_DIRECTORY[]> directories, bool is32bit)
	{
		_optional = optional;
		_specific = specific;
		_32bit = is32bit;
