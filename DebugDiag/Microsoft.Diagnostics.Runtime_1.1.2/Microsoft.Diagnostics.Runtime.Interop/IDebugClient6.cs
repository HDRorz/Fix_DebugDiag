...
public interface IDebugClient6 : IDebugClient5, IDebugClient4, IDebugClient3, IDebugClient2, IDebugClient
{
	[PreserveSig]
	new int AttachKernel([In] DEBUG_ATTACH Flags, [In][MarshalAs(UnmanagedType.LPStr)] string ConnectOptions);

	[PreserveSig]
	new int GetKernelConnectionOptions([Out][MarshalAs(UnmanagedType.LPStr)] StringBuilder Buffer, [In] int BufferSize, out uint OptionsSize);
	...
	[PreserveSig]
	new int GetRunningProcessSystemIds([In] ulong Server, [Out][MarshalAs(UnmanagedType.LPArray)] uint[] Ids, [In] uint Count, out uint ActualCount);
	...
	[PreserveSig]
	new int GetOutputLinePrefix([Out][MarshalAs(UnmanagedType.LPStr)] StringBuilder Buffer, [In] int BufferSize, out uint PrefixSize);

	[PreserveSig]
	new int SetOutputLinePrefix([In][MarshalAs(UnmanagedType.LPStr)] string Prefix);

	[PreserveSig]
	new int GetIdentity([Out][MarshalAs(UnmanagedType.LPStr)] StringBuilder Buffer, [In] int BufferSize, out uint IdentitySize);
	...
	[PreserveSig]
	new int GetRunningProcessDescriptionWide([In] ulong Server, [In] uint SystemId, [In] DEBUG_PROC_DESC Flags, [Out][MarshalAs(UnmanagedType.LPWStr)] StringBuilder ExeName, [In] int ExeNameSize, out uint ActualExeNameSize, [Out][MarshalAs(UnmanagedType.LPWStr)] StringBuilder Description, [In] int DescriptionSize, out uint ActualDescriptionSize);
	...
	[PreserveSig]
	new int GetDumpFile([In] uint Index, [Out][MarshalAs(UnmanagedType.LPStr)] StringBuilder Buffer, [In] int BufferSize, out uint NameSize, out ulong Handle, out uint Type);

	[PreserveSig]
	new int GetDumpFileWide([In] uint Index, [Out][MarshalAs(UnmanagedType.LPWStr)] StringBuilder Buffer, [In] int BufferSize, out uint NameSize, out ulong Handle, out uint Type);

	[PreserveSig]
	new int AttachKernelWide([In] DEBUG_ATTACH Flags, [In][MarshalAs(UnmanagedType.LPWStr)] string ConnectOptions);

	[PreserveSig]
	new int GetKernelConnectionOptionsWide([Out][MarshalAs(UnmanagedType.LPWStr)] StringBuilder Buffer, [In] int BufferSize, out uint OptionsSize);

	[PreserveSig]
	new int SetKernelConnectionOptionsWide([In][MarshalAs(UnmanagedType.LPWStr)] string Options);

	[PreserveSig]
	new int StartProcessServerWide([In] DEBUG_CLASS Flags, [In][MarshalAs(UnmanagedType.LPWStr)] string Options, [In] IntPtr Reserved);

	[PreserveSig]
	new int ConnectProcessServerWide([In][MarshalAs(UnmanagedType.LPWStr)] string RemoteOptions, out ulong Server);

	[PreserveSig]
	new int StartServerWide([In][MarshalAs(UnmanagedType.LPWStr)] string Options);

	[PreserveSig]
	new int OutputServersWide([In] DEBUG_OUTCTL OutputControl, [In][MarshalAs(UnmanagedType.LPWStr)] string Machine, [In] DEBUG_SERVERS Flags);

	[PreserveSig]
	new int GetOutputCallbacksWide(out IDebugOutputCallbacksWide Callbacks);

	[PreserveSig]
	new int SetOutputCallbacksWide([In] IDebugOutputCallbacksWide Callbacks);

	[PreserveSig]
	new int GetOutputLinePrefixWide([Out][MarshalAs(UnmanagedType.LPWStr)] StringBuilder Buffer, [In] int BufferSize, out uint PrefixSize);

	[PreserveSig]
	new int SetOutputLinePrefixWide([In][MarshalAs(UnmanagedType.LPWStr)] string Prefix);

	[PreserveSig]
	new int GetIdentityWide([Out][MarshalAs(UnmanagedType.LPWStr)] StringBuilder Buffer, [In] int BufferSize, out uint IdentitySize);

	[PreserveSig]
	new int OutputIdentityWide([In] DEBUG_OUTCTL OutputControl, [In] uint Flags, [In][MarshalAs(UnmanagedType.LPWStr)] string Machine);

	[PreserveSig]
	new int GetEventCallbacksWide(out IDebugEventCallbacksWide Callbacks);

	[PreserveSig]
	new int SetEventCallbacksWide([In] IDebugEventCallbacksWide Callbacks);

	[PreserveSig]
	new int CreateProcess2([In] ulong Server, [In][MarshalAs(UnmanagedType.LPStr)] string CommandLine, [In] ref DEBUG_CREATE_PROCESS_OPTIONS OptionsBuffer, [In] uint OptionsBufferSize, [In][MarshalAs(UnmanagedType.LPStr)] string InitialDirectory, [In][MarshalAs(UnmanagedType.LPStr)] string Environment);

	[PreserveSig]
	new int CreateProcess2Wide([In] ulong Server, [In][MarshalAs(UnmanagedType.LPWStr)] string CommandLine, [In] ref DEBUG_CREATE_PROCESS_OPTIONS OptionsBuffer, [In] uint OptionsBufferSize, [In][MarshalAs(UnmanagedType.LPWStr)] string InitialDirectory, [In][MarshalAs(UnmanagedType.LPWStr)] string Environment);
	...
	[PreserveSig]
	new int PushOutputLinePrefix([In][MarshalAs(UnmanagedType.LPStr)] string NewPrefix, out ulong Handle);

	[PreserveSig]
	new int PushOutputLinePrefixWide([In][MarshalAs(UnmanagedType.LPWStr)] string NewPrefix, out ulong Handle);

	[PreserveSig]
	new int PopOutputLinePrefix([In] ulong Handle);

	[PreserveSig]
	new int GetNumberInputCallbacks(out uint Count);

	[PreserveSig]
	new int GetNumberOutputCallbacks(out uint Count);

	[PreserveSig]
	new int GetNumberEventCallbacks([In] DEBUG_EVENT Flags, out uint Count);

	[PreserveSig]
	new int GetQuitLockString([Out][MarshalAs(UnmanagedType.LPStr)] StringBuilder Buffer, [In] int BufferSize, out uint StringSize);

	[PreserveSig]
	new int SetQuitLockString([In][MarshalAs(UnmanagedType.LPStr)] string LockString);

	[PreserveSig]
	new int GetQuitLockStringWide([Out][MarshalAs(UnmanagedType.LPWStr)] StringBuilder Buffer, [In] int BufferSize, out uint StringSize);

	[PreserveSig]
	new int SetQuitLockStringWide([In][MarshalAs(UnmanagedType.LPWStr)] string LockString);

	[PreserveSig]
	int SetEventContextCallbacks([In] IDebugEventContextCallbacks Callbacks);
}
