...
public interface IDebugRegisters2 : IDebugRegisters
{
	...
	[PreserveSig]
	new int GetDescription([In] uint Register, [Out][MarshalAs(UnmanagedType.LPStr)] StringBuilder NameBuffer, [In] int NameBufferSize, out uint NameSize, out DEBUG_REGISTER_DESCRIPTION Desc);
	...
	[PreserveSig]
	new int SetValue([In] uint Register, [In] ref DEBUG_VALUE Value);

	[PreserveSig]
	new int GetValues([In] uint Count, [In][MarshalAs(UnmanagedType.LPArray)] uint[] Indices, [In] uint Start, [Out][MarshalAs(UnmanagedType.LPArray)] DEBUG_VALUE[] Values);
	...
	[PreserveSig]
	int GetDescriptionWide([In] uint Register, [Out][MarshalAs(UnmanagedType.LPWStr)] StringBuilder NameBuffer, [In] int NameBufferSize, out uint NameSize, out DEBUG_REGISTER_DESCRIPTION Desc);
	...
	[PreserveSig]
	int GetPseudoDescription([In] uint Register, [Out][MarshalAs(UnmanagedType.LPStr)] StringBuilder NameBuffer, [In] int NameBufferSize, out uint NameSize, out ulong TypeModule, out uint TypeId);

	[PreserveSig]
	int GetPseudoDescriptionWide([In] uint Register, [Out][MarshalAs(UnmanagedType.LPWStr)] StringBuilder NameBuffer, [In] int NameBufferSize, out uint NameSize, out ulong TypeModule, out uint TypeId);
	...
	[PreserveSig]
	int GetValues2([In] DEBUG_REGSRC Source, [In] uint Count, [In][MarshalAs(UnmanagedType.LPArray)] uint[] Indices, [In] uint Start, [Out][MarshalAs(UnmanagedType.LPArray)] DEBUG_VALUE[] Values);
