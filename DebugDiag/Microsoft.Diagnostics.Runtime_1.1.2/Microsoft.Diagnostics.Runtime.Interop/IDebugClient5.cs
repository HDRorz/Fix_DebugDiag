...
public interface IDebugClient5 : IDebugClient4, IDebugClient3, IDebugClient2, IDebugClient
{
	...
	[PreserveSig]
	int GetKernelConnectionOptionsWide([Out][MarshalAs(UnmanagedType.LPWStr)] StringBuilder Buffer, [In] int BufferSize, out uint OptionsSize);
	...
	[PreserveSig]
	int GetOutputLinePrefixWide([Out][MarshalAs(UnmanagedType.LPWStr)] StringBuilder Buffer, [In] int BufferSize, out uint PrefixSize);

	[PreserveSig]
	int SetOutputLinePrefixWide([In][MarshalAs(UnmanagedType.LPWStr)] string Prefix);

	[PreserveSig]
	int GetIdentityWide([Out][MarshalAs(UnmanagedType.LPWStr)] StringBuilder Buffer, [In] int BufferSize, out uint IdentitySize);
	...
	[PreserveSig]
	int GetQuitLockString([Out][MarshalAs(UnmanagedType.LPStr)] StringBuilder Buffer, [In] int BufferSize, out uint StringSize);

	[PreserveSig]
	int SetQuitLockString([In][MarshalAs(UnmanagedType.LPStr)] string LockString);

	[PreserveSig]
	int GetQuitLockStringWide([Out][MarshalAs(UnmanagedType.LPWStr)] StringBuilder Buffer, [In] int BufferSize, out uint StringSize);
