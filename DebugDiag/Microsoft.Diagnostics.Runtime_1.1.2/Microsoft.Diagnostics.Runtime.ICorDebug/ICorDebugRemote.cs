...
public interface ICorDebugRemote
{
	...
	void DebugActiveProcessEx([In][MarshalAs(UnmanagedType.Interface)] ICorDebugRemoteTarget pRemoteTarget, [In] uint id, [In] int win32Attach, [MarshalAs(UnmanagedType.Interface)] out ICorDebugProcess ppProcess);
}
