...
public interface IDbgObj4
{
	...
	[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
	[DispId(64)]
	string CreateDumpForProcessIDEx([In] int ProcessID, [In][MarshalAs(UnmanagedType.BStr)] string DumpReason, [In] bool bMiniDump = true, [In] bool bCreateProcessList = true, [In] bool bUseProcessSnapshotting = false);

	[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
	[DispId(65)]
	[return: MarshalAs(UnmanagedType.Struct)]
	object CreateDumpForProcessNameEx([In][MarshalAs(UnmanagedType.BStr)] string ProcessName, [In][MarshalAs(UnmanagedType.BStr)] string DumpReason, [In] bool bMiniDump = true, [In] bool bCreateProcessList = true, [In] bool bUseProcessSnapshotting = false);
}
