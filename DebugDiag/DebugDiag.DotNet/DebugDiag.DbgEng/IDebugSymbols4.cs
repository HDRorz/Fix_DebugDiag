...
public interface IDebugSymbols4 : IDebugSymbols3, IDebugSymbols2, IDebugSymbols
{
	...
	[PreserveSig]
	unsafe int GetScopeEx([In] ulong* InstructionOffset, [In] DEBUG_STACK_FRAME_EX* ScopeFrame, [In] IntPtr ScopeContext, [In] uint ScopeContextSize);
	...
	[PreserveSig]
	unsafe int GetNameByInlineContext([In] ulong Offset, [In] uint InlineContext, [Out][MarshalAs(UnmanagedType.LPStr)] StringBuilder NameBuffer, [In] int NameBufferSize, [In] uint* NameSize, [In] ulong* Displacement);

	[PreserveSig]
	unsafe int GetNameByInlineContextWide([In] ulong Offset, [In] uint InlineContext, [Out][MarshalAs(UnmanagedType.LPWStr)] StringBuilder NameBuffer, [In] int NameBufferSize, [In] uint* NameSize, [In] ulong* Displacement);

	[PreserveSig]
	unsafe int GetLineByInlineContext([In] ulong Offset, [In] uint InlineContext, [In] uint* Line, [Out][MarshalAs(UnmanagedType.LPStr)] StringBuilder FileBuffer, [In] int FileBufferSize, [In] uint* FileSize, [In] ulong* Displacement);

	[PreserveSig]
	unsafe int GetLineByInlineContextWide([In] ulong Offset, [In] uint InlineContext, [In] uint* Line, [Out][MarshalAs(UnmanagedType.LPWStr)] StringBuilder FileBuffer, [In] int FileBufferSize, [In] uint* FileSize, [In] ulong* Displacement);
