...
{
	private unsafe IMAGE_DOS_HEADER* _dosHeader;

	private unsafe IMAGE_NT_HEADERS* _ntHeader;

	private unsafe IMAGE_SECTION_HEADER* _sections;
	...
	private unsafe IMAGE_DATA_DIRECTORY* ntDirectories
	{
		get
		{
			if (IsPE64)
			{
				return (IMAGE_DATA_DIRECTORY*)((byte*)(_ntHeader + 1) + sizeof(IMAGE_OPTIONAL_HEADER64));
			}
			return (IMAGE_DATA_DIRECTORY*)((byte*)(_ntHeader + 1) + sizeof(IMAGE_OPTIONAL_HEADER32));
		}
	}
	...
	public unsafe IMAGE_DATA_DIRECTORY Directory(int idx)
	{
