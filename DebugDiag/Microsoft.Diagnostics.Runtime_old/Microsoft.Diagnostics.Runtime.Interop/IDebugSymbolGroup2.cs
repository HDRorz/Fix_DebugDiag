...
public interface IDebugSymbolGroup2 : IDebugSymbolGroup
{
	...
	[PreserveSig]
	new int GetSymbolName([In] uint Index, [Out][MarshalAs(UnmanagedType.LPStr)] StringBuilder Buffer, [In] int BufferSize, out uint NameSize);
	...
	[PreserveSig]
	int GetSymbolNameWide([In] uint Index, [Out][MarshalAs(UnmanagedType.LPWStr)] StringBuilder Buffer, [In] int BufferSize, out uint NameSize);
	...
	[PreserveSig]
	int GetSymbolTypeName([In] uint Index, [Out][MarshalAs(UnmanagedType.LPStr)] StringBuilder Buffer, [In] int BufferSize, out uint NameSize);

	[PreserveSig]
	int GetSymbolTypeNameWide([In] uint Index, [Out][MarshalAs(UnmanagedType.LPWStr)] StringBuilder Buffer, [In] int BufferSize, out uint NameSize);
	...
	[PreserveSig]
	int GetSymbolValueText([In] uint Index, [Out][MarshalAs(UnmanagedType.LPStr)] StringBuilder Buffer, [In] int BufferSize, out uint NameSize);

	[PreserveSig]
	int GetSymbolValueTextWide([In] uint Index, [Out][MarshalAs(UnmanagedType.LPWStr)] StringBuilder Buffer, [In] int BufferSize, out uint NameSize);

	[PreserveSig]
	int GetSymbolEntryInformation([In] uint Index, out DEBUG_SYMBOL_ENTRY Info);
}
