...
public interface IDebugBreakpoint3 : IDebugBreakpoint2, IDebugBreakpoint
{
	[PreserveSig]
	...
	[PreserveSig]
	new int GetCommand([Out][MarshalAs(UnmanagedType.LPStr)] StringBuilder Buffer, [In] int BufferSize, out uint CommandSize);

	[PreserveSig]
	new int SetCommand([In][MarshalAs(UnmanagedType.LPStr)] string Command);

	[PreserveSig]
	new int GetOffsetExpression([Out][MarshalAs(UnmanagedType.LPStr)] StringBuilder Buffer, [In] int BufferSize, out uint ExpressionSize);
	...
	[PreserveSig]
	new int GetCommandWide([Out][MarshalAs(UnmanagedType.LPWStr)] StringBuilder Buffer, [In] int BufferSize, out uint CommandSize);

	[PreserveSig]
	new int SetCommandWide([In][MarshalAs(UnmanagedType.LPWStr)] string Command);

	[PreserveSig]
	new int GetOffsetExpressionWide([Out][MarshalAs(UnmanagedType.LPWStr)] StringBuilder Buffer, [In] int BufferSize, out uint ExpressionSize);

	[PreserveSig]
	new int SetOffsetExpressionWide([In][MarshalAs(UnmanagedType.LPWStr)] string Command);
