...
public abstract class ClrType
{
	...
	public virtual ClrType ArrayComponentType { get; internal set; }
	...
	public virtual object GetFieldValue(ulong obj, ICollection<string> fields)
	{
		throw new NotImplementedException();
	}

	[Obsolete("This method will be removed 1.0 RTM, you will need to reimplement it if you use it.")]
	public virtual bool TryGetFieldValue(ulong obj, ICollection<string> fields, out object value)
	{
		value = null;
		return false;
	}
